...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int SINGLE_PET_ID =111;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in order to figure out if we're creating a new pet or editing it
        ...
        if(currentPetUri == null) {
            ...
            getLoaderManager().initLoader(SINGLE_PET_ID, null, this);
        }
    ...
    private void savePet(){
        ...
        String nameString = mNameEditText.getText().toString().trim(); //eliminate extra leading or trailing whitespaces
